    ...
    <section class="content">
      ...
      <div class="container-fluid">
        ...
        <?php
           ...
           if(isset($_SESSION['our_event_post'])){ ?>

              <div class="alert alert-success" id="success-alert" role="alert">
              <?php echo $_SESSION['our_event_post']; unset($_SESSION['our_event_post']); ?>
              </div>

            <?php }else if(isset($_SESSION['event_post_error'])){ ?>
    
               <div class="alert alert-danger" id="success-alert" role="alert">
               <?php echo $_SESSION['event_post_error']; unset($_SESSION['event_post_error']); ?>
              </div>
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <div class="card-body">
          <form action="action/ourEventsPost.php" method="post" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-12">
              ...
              <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="time" class="form-control" name="time" id="exampleFormControlInput1"  autocomplete="off" required>
                  </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                    <label for="mobile">location*</label>
                    <input type="text" class="form-control" name="location" id="exampleFormControlInput1" placeholder="Type Location" autocomplete="off" required>
                  </div>
              </div>
            </div>
