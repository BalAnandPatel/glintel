 <footer class="main-footer">
    <strong>Poewrd by <a href="https://adminlte.io">Glintel Technologies Pvt Ltd</a>.</strong>
...
<!-- dropzonejs -->
<script src="../common/plugins/dropzone/min/dropzone.min.js"></script>
<!-- AdminLTE App -->
<script src="dist/js/adminlte.min.js"></script>

<!----------JQUERY ADD FOR DATA TBLES------------------->
...
<!-- This script for success aleart -->
