<?php
  ...
  $url = $URL."events/ourEventsCreate.php";

  $data = array('title'=>$title, 'time'=>$time, 'location'=>$location, 'description'=>$description, 'image'=>$image, 'createdBy'=>$createdBy, 'createdOn'=>$time);
  //print_r($data);
